...
class ViewController: UIViewController {
    ...
    func calculateStreak(goals: [Goal]) {
        struct FakeGoal {
            var title: String!
        ...
        do {
            ...
            for goal in fakeGoals {
                ...
                let currentStreakTitle = UILabel()
                currentStreakTitle.text = "Current Streak"
                currentStreakTitle.font = UIFont.caption.with(weight: .bold)
                currentStreakTitle.textColor = .lightGray
                
                let longestStreakTitle = UILabel()
                longestStreakTitle.text = "Longest Streak"
                longestStreakTitle.font = UIFont.caption.with(weight: .bold)
                longestStreakTitle.textColor = .lightGray
                ...
                addCard(text: goal.title, subItem: streakContainer, stackView: stackView, containerHeight: 130, bottomSpacing: 30)
            }
        } catch {
            print("error")
        }
