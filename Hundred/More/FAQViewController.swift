...
class FAQViewController: UITableViewController {
    ...
    let qanda4 = QandA(question: "Will any of my iCloud information show if I choose to post any entries on the Public Feed?", answer: "No. You get to choose any username you want and your email will not be displayed.")
